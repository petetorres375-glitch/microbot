...
- Places **atomic bracket orders** on **Alpaca paper account** — entry + stop + take-profit submitted as one unit; if the entry fills, the stop and target are guaranteed to exist
