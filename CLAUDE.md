...
| Symbol | Entry | Notes |
|---|---|---|
| CCL | $28.60 | Carnival Corp. EMA pullback. 25 shares. Stop $26.63, target $32.53. Engine entry 2026-06-30. Currently $28.52, −$2.00 (−0.28%). |
| CSCO | $117.88 | Cisco. Trend momentum. 8 shares. Stop $111.70, target $129.84. Re-entry 2026-06-29 (GTC filled 2026-06-30 open). Currently $116.71, −$9.36 (−0.99%). |
| F | $14.37 | Ford. EMA pullback. 54 shares. Stop $13.34 (HELD), target $16.07. Currently $13.63, −$39.96 (−5.15%) — approaching stop. |
| GOOG | $359.33 | Google. Trend momentum re-entry 2026-07-01 (prior entry stopped Jun 22 at −1R). 3 shares. Stop ~$341.60, target ~$391.49 (bracket). CLEAN verdict Jul 1. Engine ran late (Drive bridge delay) — executed manually 10:31 AM. Currently $357.25, −$6.24 (−0.58%). |

Total unrealized P/L across open positions (as of 2026-07-01 ~6:37 PM ET): −$57.56. Realized today: FCEL +$38.50, BTI +$20.27, SPCX −$36.01 = net +$22.76.

SPCX (personal long-term hold, separate from the 4 positions above) stopped out 2026-07-01, filled $157.62 — see "SPCX Long-Term Hold" section above.
