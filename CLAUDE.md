...
## Current focused universe (as of 2026-07-06 ~7:54 PM ET, market closed)

Active portfolio: **CCL, CSCO, ET, GOOG** (swing only — all intraday/personal-hold positions closed same day). `MAX_OPEN_POSITIONS=8` — 4/8.

| Symbol | Entry | Notes |
|---|---|---|
| CCL | $28.60 | Carnival Corp. EMA pullback. 25 shares. Stop $26.63 (live, HELD), target $32.53. Engine entry 2026-06-30. Currently $27.57, −$25.75 (−3.60%). |
| CSCO | $117.88 | Cisco. Trend momentum. 8 shares. Stop $111.70 (live, HELD), target $129.84. Re-entry 2026-06-29 (GTC filled 2026-06-30 open). Currently $113.95, −$31.44 (−3.33%). Verdict Jul 6: CAUTION (valuation/margin/insider-selling concerns) — doesn't force a close, just blocks the engine from adding to it. |
| ET | $19.47 | Energy Transfer. Dividend momentum. 72 shares. Stop $18.76, target $20.84. Engine auto-entry 2026-07-06 (CLEAN verdict). Currently $19.31, −$11.52 (−0.82%). |
| GOOG | $359.33 | Google. Trend momentum re-entry 2026-07-01 (prior entry stopped Jun 22 at −1R). 3 shares. Stop $341.60 (live, HELD), target $391.49 (bracket). Currently $364.77, +$16.32 (+1.51%). Verdict Jul 6: CLEAN. |

Total unrealized P/L across open positions (as of 2026-07-06 ~7:52 PM ET): −$52.39.

**Intraday (ORB) closed same day:** PENG and SOXL, opened 9:34 AM from the gap scan, both trailed up and stopped out at the 3:55 PM hard close — SOXL +$15.00, PENG +$14.11. Day P&L +$29.11.

**SPCX reclaim re-entry stopped out same day:** the $164.88 fill from the morning reclaim (see "SPCX Long-Term Hold" above) hit its manually-placed stop at 1:48 PM ET, filling 6 shares @ $156.67 avg (~−$49.27, ~−1.0R). Not held as of this snapshot; `watch_spcx.py` cron is back to watching for a fresh $163.62 reclaim.
